...
# vamos criar uma nova coluna, modelo_carro_aleatorio
...
# o cv aceita passar um objeto especial KFold também
# pois por baixo dos panos, quando você passa um número somente, ele cria o Kfold com esse número
